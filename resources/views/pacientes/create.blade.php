@extends('layouts.app', [
    'title' => 'Nuevo Paciente | Gestion de Formulas Medicas',
])
...
@section('content')
    ...
    <article class="entity-form-card">
        <div class="entity-form-head">
            <h3 class="entity-form-title">Datos del nuevo paciente</h3>
        ...
        @if ($errors->any())
            <div class="mb-4 rounded-2xl border border-rose-200 bg-rose-50 px-4 py-3 text-sm text-rose-700">
                <p class="font-semibold">No se pudo guardar el paciente.</p>
        ...
        <form method="POST" action="{{ route('pacientes.store') }}" data-feedback-form="true" class="entity-form-grid entity-form-grid-two">
            ...
            <div class="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-600 entity-form-span-2">
                El nombre de acceso se genera automaticamente con los nombres y apellidos del paciente.
            </div>
            ...
            <div>
                ...
                <select name="eps" required class="select-control w-full" data-searchable="true" data-search-limit="10" data-search-placeholder="Busca una EPS por nombre">
            ...
            <div class="entity-form-actions entity-form-span-2">
                ...
                <button type="submit" class="btn btn-teal">Guardar paciente</button>
            </div>
        </form>
        </div>
    </article>
