            ...
            <div class="entity-form-body">
                ...
                <form method="POST" action="{{ route('entregas.update', $entrega) }}" data-feedback-form="true" class="entity-form-grid entity-form-grid-two">
                    ...
                    <div>
                        ...
                        <input type="number" name="cantidad_entregada" value="{{ old('cantidad_entregada', $entrega->cantidad_entregada) }}" min="1" required class="input-control w-full">
                    </div>
                    ...
                    <div class="entity-form-span-2">
                        ...
                        <textarea name="observaciones" rows="3" class="input-control w-full">{{ old('observaciones', $entrega->observaciones) }}</textarea>
                    </div>
